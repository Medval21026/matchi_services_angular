...
export class TranslationService {
  ...
  private loadTranslations(): void {
    ...
    this.translations.fr = {
      ...
      'abonnement.endDateAuto': 'La date de fin sera automatiquement calculée (date de début + 30 jours)',
      ...
      'abonnement.willBeDeleted': 'sera supprimé',
      ...
      'profil.personalInfo': 'Informations personnelles',
      'profil.nom': 'Nom',
      'profil.prenom': 'Prénom',
      'profil.telephone': 'Téléphone',
      'profil.changePassword': 'Modifier le mot de passe',
      'profil.currentPassword': 'Mot de passe actuel',
      'profil.newPassword': 'Nouveau mot de passe',
      'profil.confirmPassword': 'Confirmer le nouveau mot de passe',
      'profil.updateButton': 'Mettre à jour',
      'profil.updating': 'Mise à jour...',
      'profil.updatePasswordButton': 'Modifier le mot de passe',
      'profil.updatingPassword': 'Modification...',
      'profil.updatedSuccess': 'Profil mis à jour avec succès',
      'profil.passwordUpdatedSuccess': 'Mot de passe modifié avec succès',
      'profil.loadError': 'Erreur lors du chargement du profil',
      'profil.updateError': 'Erreur lors de la mise à jour du profil',
      'profil.passwordUpdateError': 'Erreur lors de la modification du mot de passe',
      'profil.invalidCurrentPassword': 'Le mot de passe actuel est incorrect',
      'profil.passwordMismatch': 'Les mots de passe ne correspondent pas',
      'profil.passwordMinLength': 'Le mot de passe doit contenir au moins 6 caractères',
      'profil.fieldRequired': 'Ce champ est requis',
      'profil.fieldInvalidFormat': 'Format invalide',
      'profil.invalidData': 'Données invalides',
      'profil.unauthorized': 'Non autorisé',
      'profil.notFound': 'Profil non trouvé',
      'profil.serverError': 'Erreur serveur',
    ...
    this.translations.ar = {
      ...
      'abonnement.endDateAuto': 'سيتم حساب تاريخ النهاية تلقائياً (تاريخ البداية + 30 يوماً)',
      ...
      'abonnement.willBeDeleted': 'سيتم حذفه',
      ...
      'profil.personalInfo': 'المعلومات الشخصية',
      'profil.nom': 'الاسم',
      'profil.prenom': 'الاسم الأول',
      'profil.telephone': 'الهاتف',
      'profil.changePassword': 'تغيير كلمة المرور',
      'profil.currentPassword': 'كلمة المرور الحالية',
      'profil.newPassword': 'كلمة المرور الجديدة',
      'profil.confirmPassword': 'تأكيد كلمة المرور الجديدة',
      'profil.updateButton': 'تحديث',
      'profil.updating': 'جاري التحديث...',
      'profil.updatePasswordButton': 'تغيير كلمة المرور',
      'profil.updatingPassword': 'جاري التعديل...',
      'profil.updatedSuccess': 'تم تحديث الملف الشخصي بنجاح',
      'profil.passwordUpdatedSuccess': 'تم تغيير كلمة المرور بنجاح',
      'profil.loadError': 'خطأ في تحميل الملف الشخصي',
      'profil.updateError': 'خطأ في تحديث الملف الشخصي',
      'profil.passwordUpdateError': 'خطأ في تغيير كلمة المرور',
      'profil.invalidCurrentPassword': 'كلمة المرور الحالية غير صحيحة',
      'profil.passwordMismatch': 'كلمات المرور غير متطابقة',
      'profil.passwordMinLength': 'يجب أن تحتوي كلمة المرور على 6 أحرف على الأقل',
      'profil.fieldRequired': 'هذا الحقل مطلوب',
      'profil.fieldInvalidFormat': 'تنسيق غير صالح',
      'profil.invalidData': 'بيانات غير صالحة',
      'profil.unauthorized': 'غير مصرح',
      'profil.notFound': 'الملف الشخصي غير موجود',
      'profil.serverError': 'خطأ في الخادم',
